package ricardosornosa.a2025_2026dam2bpmdmlistacompra.adapters;
...
import ricardosornosa.a2025_2026dam2bpmdmlistacompra.Constantes;
import ricardosornosa.a2025_2026dam2bpmdmlistacompra.MainActivity;
import ricardosornosa.a2025_2026dam2bpmdmlistacompra.R;
...
public class ProductoAdapter extends RecyclerView.Adapter<ProductoAdapter.ProductoVH> {
    ...
    public ProductoAdapter(List<ProductoModel> objects, int resource, Context context) {
        ...
        this.sp = context.getSharedPreferences(
                Constantes.DATOS, context.MODE_PRIVATE);
        this.gson = new Gson();
    }
    ...
    private AlertDialog modificarProducto(ProductoModel p) {
        ...
        View productoViewAlert = LayoutInflater.from(context).inflate(R.layout.producto_view_alert, null);
        ...
        builder.setPositiveButton("MODIFICAR", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (!nombre.isEmpty() && !cantidadS.isEmpty() && !importeS.isEmpty()) {
                    p.setNombre(nombre);
                    p.setCantidad(Integer.parseInt(cantidadS));
                    p.setImporte(Float.parseFloat(importeS));
